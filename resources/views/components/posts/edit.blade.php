...
<div class="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden mb-12">
    <div class="p-8 sm:p-12">
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            <div>
                <h3 class="text-3xl font-black text-[#0f172a] tracking-tight">Edit Story</h3>
                <p class="text-slate-500 mt-2 font-bold leading-relaxed">Make changes to your article below to keep it
                    fresh and engaging.</p>
            </div>
            <div class="hidden md:block">
                <span
                    class="px-4 py-2 bg-indigo-50 text-indigo-600 text-[10px] font-black uppercase tracking-widest rounded-full">Editing
                    Story</span>
            </div>
        </div>
            ...
            <div class="space-y-4">
                ...
                <div class="relative group">
                    <div id="image-preview-container"
                        class="{{ $post->image ? '' : 'hidden' }} relative w-full aspect-video rounded-3xl overflow-hidden border-2 border-slate-100 mb-4 bg-slate-50">
                    ...
                    <label id="upload-placeholder"
                        class="{{ $post->image ? 'hidden' : '' }} cursor-pointer flex flex-col items-center justify-center w-full aspect-video rounded-3xl border-2 border-dashed border-slate-200 bg-slate-50 hover:bg-indigo-50/50 hover:border-indigo-200 transition-all group">
